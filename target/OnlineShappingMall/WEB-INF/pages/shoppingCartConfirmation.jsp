...
<body>
  ...
  <form method="POST"
      action="<%=request.getContextPath() %>/shoppingCartConfirmation">
 
      <!-- Edit Cart -->
      <a class="navi-item"
          href="<%=request.getContextPath() %>/shoppingCart">Edit Cart</a>
 
      <!-- Edit Customer Info -->
      <a class="navi-item"
          href="<%=request.getContextPath() %>/shoppingCartCustomer">Edit
          Customer Info</a>
          ...
          <div class="product-preview-container">
              <ul>
                  <li><img class="product-image"
                      src="<%=request.getContextPath() %>/productImage?code=${cartLineInfo.productInfo.code}" /></li>
